...
@Component({
  ...
  templateUrl: './policelisting.page.html',
  styleUrls: ['./policelisting.page.scss'],
})
export class PolicelistingPage implements OnInit {
  map: any;
  ...
  constructor(private navController: NavController,public translate:TranslateService,public alertController: AlertController,private iab: InAppBrowser,private callNumber: CallNumber, private route: ActivatedRoute, private router: Router,public httpClient: HttpClient) {
